...
dirs = os.listdir(r'E:\PROGRAMMING\Projects\Django_Projects\Django_Disease_Prediction\SHDPS_MODEL_SELECTION\Datasets')
dirs = dirs[1]
...
#loading model
# model = jb.load(r'C:\\Users\Faiyaz\Desktop\Django_Disease_Prediction-new_models\shdps\ModelAI\model')
...
def get_disease_with_max_accuracy(user_symptoms , Y_train , Y):
   disease_and_Cs = []
   dt_model = jb.load(r'E:\PROGRAMMING\Projects\Django_Projects\Django_Disease_Prediction\SHDPS_MODEL_SELECTION\Decision_Tree\Decision_Tree_Model.sav')
   knn_model = jb.load(r'E:\PROGRAMMING\Projects\Django_Projects\Django_Disease_Prediction\SHDPS_MODEL_SELECTION\K_Nearest_Neighbors\KNN_Model.sav')
   svm_model = jb.load(r'E:\PROGRAMMING\Projects\Django_Projects\Django_Disease_Prediction\SHDPS_MODEL_SELECTION\Kernel_SVM\Kernel_SVM_Model.sav')
   lr_model = jb.load(r'E:\PROGRAMMING\Projects\Django_Projects\Django_Disease_Prediction\SHDPS_MODEL_SELECTION\Logistic_Regression\Logistic_Regression_Model.sav')
   ...
   rf_model = jb.load(r'E:\PROGRAMMING\Projects\Django_Projects\Django_Disease_Prediction\SHDPS_MODEL_SELECTION\Random_Forest\Random_Forest_Model.sav')
